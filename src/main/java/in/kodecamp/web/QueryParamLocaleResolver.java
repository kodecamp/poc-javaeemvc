 ...
 * <i>lang</i>. In case there is no request param with this name, the
 * {@link Locale} will be resolved by a higher prioritised implementation.
 * Example usage:
 *
 * <pre>
 * {@code
...
public class QueryParamLocaleResolver implements LocaleResolver {
    ...
    public Locale resolveLocale(final LocaleResolverContext context) {
        final String queryLang = context.getUriInfo().getQueryParameters().getFirst("lang");
