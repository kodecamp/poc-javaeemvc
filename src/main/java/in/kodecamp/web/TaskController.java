...
import in.kodecamp.domain.Task;
import in.kodecamp.domain.TaskRepository;
import in.kodecamp.web.AlertMessage.Type;
...
public class TaskController {
    ...
    public void allTasks() {
        ...
        log
           .log(Level.INFO, "got all tasks: todotasks@{0}, doingtasks@{1}, donetasks@{2}",
    ...
    @Path("new")
    public String add() {
        log.log(Level.INFO, "-> ADD_NEW_TASK");
    ...
    public Response update(@PathParam(value = "id") Long id, @Valid @BeanParam TaskForm form) {
        log
           .log(Level.INFO, "updating existed task@id:{0}, form data:{1}",
                new Object[] { id, form });
    ...
    public Response updateStatus(@PathParam(value = "id") Long id,
        ...
        log
           .log(Level.INFO, "updating status of the existed task@id:{0}, status:{1}",
